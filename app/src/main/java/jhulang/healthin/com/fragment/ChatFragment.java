...
import jhulang.healthin.com.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int[] icon = {R.drawable.ic_doctor, R.drawable.ic_doctor, R.drawable.ic_doctor};
    String[] nama = {"Dr. Diyah", "Dr. Pandu", "Dr. Amrul"};
    String[] deskripsi = {"Dokter Umum", "Spesialis Kulit", "Dokter Kecantikan"};
